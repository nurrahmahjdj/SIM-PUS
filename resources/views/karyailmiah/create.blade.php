...
@section('container')
    <form class="row justify-content-evenly" method="POST" action="/karyailmiah" enctype="multipart/form-data"
        onload="tampilFile()">
        @csrf
        <input class="d-none" type="text" name="slug" id="slug" value="{{ old('slug') }}{{ mt_rand(0, 9) }}">
        @error('slug')
        ...
        <div class="col-lg-7">
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <select class="form-select shadow-sm border-0 @error('tipe') is-invalid @enderror" name="tipe"
                        id="tipe" onchange="tampilFile()"
                        @if (old('tipe')) style="display: none;" @endif>
                    ...
                    @enderror
                    @if (old('tipe'))
                        <div class="invalid-feedback text-muted d-block text-end">
                            Reload halaman untuk memilih tipe karya ilmiah yang lain
                        </div>
                    @endif
                </div>
            </div>
            <div class="mb-3 row haki hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control shadow-sm border-0 mb-3 @error('no_hki') is-invalid @enderror"
                        name="no_hki" id="no_hki" value="{{ old('no_hki') }}" onkeyup="createTextSlugFromHKI()">
                </div>
                @error('no_hki')
                    <div class="invalid-feedback d-block text-end">
                        {{ $message }}
            ...
            <div class="mb-3 row haki hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="date"
                        ...
                        name="tanggal_permohonan" id="tanggal_permohonan" value="{{ old('tanggal_permohonan') }}">
                </div>
            ...
            <div class="mb-3 row haki hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="text"
                        class="form-control shadow-sm border-0 mb-3 @error('nama_pemegang') is-invalid @enderror"
                        name="nama_pemegang" id="nama_pemegang" value="{{ old('nama_pemegang') }}">
                </div>
                @error('nama_pemegang')
                    <div class="invalid-feedback d-block text-end">
                        {{ $message }}
            ...
            <div class="mb-3 row haki hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <select class="form-select shadow-sm border-0 @error('jenis_ciptaan') is-invalid @enderror"
                        name="jenis_ciptaan">
                        <option disabled selected>Pilih Jenis Ciptaan</option>
                        @foreach ($jenis_ciptaans as $jenis_ciptaan)
                            @if (old('jenis_ciptaan') == $jenis_ciptaan)
            ...
            <div class="mb-3 row skripsi jurnal haki hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input class="form-control shadow-sm border-0 @error('judul') is-invalid @enderror" rows="2"
                        name="judul" id="judul" onkeyup="createTextSlugFromJudul()" value="{{ old('judul') }}">
                </div>
                @error('judul')
            ...
            <div class="mb-3 row jurnal skripsi hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="text"
                        class="form-control shadow-sm border-0 @error('kata_kunci') is-invalid @enderror"
                        name="kata_kunci" value="{{ old('kata_kunci') }}">
                </div>
                @error('kata_kunci')
                    <div class="invalid-feedback d-block text-end">
                        {{ $message }}
            ...
            <div class="mb-3 row jurnal hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="text"
                        ...
                        name="nama_jurnal" id="nama_jurnal" value="{{ old('nama_jurnal') }}">
                </div>
                @error('nama_jurnal')
                    <div class="invalid-feedback d-block text-end">
                        {{ $message }}
            ...
            <div class="mb-3 row jurnal hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="text"
                        ...
                        name="tautan_laman" id="tautan_laman" value="{{ old('tautan_laman') }}">
                </div>
                @error('tautan_laman')
                    <div class="invalid-feedback d-block text-end">
                        {{ $message }}
            ...
            <div class="mb-3 row jurnal hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="text"
                        class="form-control shadow-sm border-0 mb-3 @error('volume') is-invalid @enderror" name="volume"
            ...
            <div class="mb-3 row jurnal hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <input type="text"
                        ...
                        name="halaman" id="halaman" value="{{ old('halaman') }}">
                </div>
                @error('halaman')
                    <div class="invalid-feedback d-block text-end">
                        {{ $message }}
            ...
            <div class="mb-3 row jurnal skripsi hide" style="display: none!important;">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control shadow-sm border-0 @error('referensi') is-invalid @enderror" rows="2"
                        name="referensi">{{ old('referensi') }}</textarea>
                </div>
                @error('referensi')
                    <div class="invalid-feedback d-block text-end">
                        {{ $message }}
            ...
            <div class="mb-3 row jurnal skripsi hide px-2" style="display: none!important;">
                <input id="abstrak" name="abstrak" type="hidden" name="content" value="{{ old('abstrak') }}">
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        <label for="cover" class="form-label">Cover <span class="text-secondary"
                                style="font-size: 10px;">max. 2 mb *pdf</span></label>
                        <label class="text-secondary mb-3" style="font-size: 10px; text-align: justify;">File terlampir
                            berupa cover, lembar pengesahan, pernyataan penulis, kata pengantar</label>
                        <input class="form-control form-control-sm @error('cover') is-invalid @enderror" type="file"
                            name="cover" accept="application/pdf">
                        @error('cover')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('file_abstrak') is-invalid @enderror"
                            type="file" name="file_abstrak" accept="application/pdf">
                        @error('file_abstrak')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('daftar_isi') is-invalid @enderror"
                            type="file" name="daftar_isi" accept="application/pdf">
                        @error('daftar_isi')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('bab_i') is-invalid @enderror" type="file"
                            name="bab_i" accept="application/pdf">
                        @error('bab_i')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('bab_ii') is-invalid @enderror" type="file"
                            name="bab_ii" accept="application/pdf">
                        @error('bab_ii')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('bab_iii') is-invalid @enderror" type="file"
                            name="bab_iii" accept="application/pdf">
                        @error('bab_iii')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('bab_iv') is-invalid @enderror" type="file"
                            name="bab_iv" accept="application/pdf">
                        @error('bab_iv')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('bab_v') is-invalid @enderror" type="file"
                            name="bab_v" accept="application/pdf">
                        @error('bab_v')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 skripsi hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('daftar_pustaka') is-invalid @enderror"
                            type="file" name="daftar_pustaka" accept="application/pdf">
                ...
                <div class="row mb-3 py-2 haki hide">
                    ...
                    <div class="col-9 mb-3">
                        <label for="sertifikat" class="form-label">Sertifikat <span class="text-secondary"
                                style="font-size: 10px;">max. 512 kb *pdf</span></label>
                        <input class="form-control form-control-sm @error('sertifikat') is-invalid @enderror"
                            type="file" name="sertifikat" accept="application/pdf">
                        @error('sertifikat')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 py-2 jurnal hide">
                    ...
                    <div class="col-9 mb-3">
                        ...
                        <input class="form-control form-control-sm @error('file_jurnal') is-invalid @enderror"
                            type="file" name="file_jurnal" accept="application/pdf">
                        @error('file_jurnal')
                            <div class="invalid-feedback d-block text-end">
                                {{ $message }}
                            </div>
